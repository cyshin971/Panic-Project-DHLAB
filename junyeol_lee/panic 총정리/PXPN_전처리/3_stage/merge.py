...
# (2) 모든 CSV 불러오기
preprocessed = load_and_clean("/Users/lee-junyeol/Downloads/panic 총정리/PXPN_전처리/1_stage/전처리 결과/processed.csv")
band_power            = load_and_clean("/Users/lee-junyeol/Downloads/panic 총정리/PXPN_전처리/2_stage/processed/bandpower.csv")
circadian_delta       = load_and_clean("/Users/lee-junyeol/Downloads/panic 총정리/PXPN_전처리/2_stage/processed/circadian_delta.csv")
step_delta = load_and_clean("/Users/lee-junyeol/Downloads/panic 총정리/PXPN_전처리/2_stage/processed/step_delta.csv")
HR_date               = load_and_clean("/Users/lee-junyeol/Downloads/panic 총정리/PXPN_전처리/2_stage/processed/HR_date.csv")
sleep                 = load_and_clean("/Users/lee-junyeol/Downloads/panic 총정리/PXPN_전처리/2_stage/processed/sleep_type.csv")
...
merged_full.to_csv("/Users/lee-junyeol/Downloads/panic 총정리/PXPN_전처리/result/result_before_severity.csv")


# 1. Load all_data and prepare the 'severity' column
all_data_path = "/Users/lee-junyeol/Downloads/panic 총정리/PXPN_전처리/result/result_before_severity.csv"
...
zip_path = "/Users/lee-junyeol/Downloads/panic 총정리/PXPN_전처리/1_stage/초기_파일_폴더/PXPN/PXPN_dropbox/pixelpanic_raw_data.zip"
...
output_path = "/Users/lee-junyeol/Downloads/panic 총정리/PXPN_전처리/result/result.csv"
