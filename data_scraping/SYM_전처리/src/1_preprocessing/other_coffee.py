...
alcohol_raw = load_raw_file(paths, sheet_name="생활패턴-카페인")
...
df.to_csv("/Users/lee-junyeol/Downloads/github/Panic-Project-DHLAB/junyeol_lee/panic 총정리/SYM_전처리/data/processed/coffee_per_date.csv")