...
alcohol_raw = load_raw_file(paths, sheet_name="생활패턴-운동")
...
df.to_csv("/Users/lee-junyeol/Downloads/github/Panic-Project-DHLAB/junyeol_lee/panic 총정리/SYM_전처리/data/processed/exercise_per_date.csv")