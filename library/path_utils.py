...
def get_file_path(dir_str: Union[str, Path], file_name: str) -> Path:
    """
    Constructs an absolute file path by joining a directory path and a filename.

    Args:
        dir_str (str | Path): The relative directory path.
        file_name (str): The name of the file.
    
    Returns:
        Path: The absolute path of the file.
    """
    return to_absolute_path(dir_str) / file_name
